  ...
  return (
    ...
    >
      ...
      <List sx={{marginTop: '15px'}}>
        ...
        {isStudent && (
          <ListItem 
            sx={getListItemStyles('/face-registration')} 
            button 
            component={Link} 
          ...
          >
            <ListItemIcon sx={{display: 'flex', justifyContent: 'center'}}>
              <FaceIcon sx={{ 
                color: currentPath === '/face-registration' ? '#1976d2' : '#727272',
                transition: 'color 0.3s ease'
              }} />
            </ListItemIcon>
            <ListItemText primary="Face" sx={currentPath === '/face-registration' ? selectedListItemTextStyle : listItemTestStyle} />
          </ListItem>
        )}
      </List>
    </Drawer>
