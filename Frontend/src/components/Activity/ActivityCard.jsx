...
import MoreOptionsAtCard from "./MoreOptionsAtCard";
                ...
                <Box sx={cardContent}>
                    <Box>
                        <Box sx={topicAndThreeDotBox}>
                            <span style={from}>From: Phuong CNTT</span> 
                        </Box>
                        <Box>
                            <span style={content}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et maiores tempora ipsum consequatur laborum. Fugit quo, quas cumque velit harum, illo natus consequatur itaque temporibus et animi officiis nisi sint!</span>
                        </Box>
                    </Box>
                </Box>               
            </Link>
